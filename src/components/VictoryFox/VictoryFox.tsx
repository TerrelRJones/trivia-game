...
const VictoryFoxContainer = styled.div`
  ...
  .helmet {
    ...
    animation: hinge 0.8s ease-in-out infinite;
  ...
  .right-arm {
    ...
    animation: swing2 0.8s ease-in-out infinite;
    @keyframes swing2 {
      0% {
        transform: rotate(-2deg);
      }
  ...
  .tail {
    ...
    animation: tailSwing 0.8s ease-in-out infinite;
    @keyframes tailSwing {
      0% {
        transform: rotate(-2deg);
      }
...
export const VictoryFox = ({ testID }: VictoryFoxProps) => {
  return (
    <VictoryFoxContainer data-testid={testID}>
      <svg height="269" width="312" xmlns="http://www.w3.org/2000/svg">
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <path
            d="M79.902 268H68.406v-32h23zM138.903 268h11.503v-32h-23z"
            fill="#62717f"
          />
          <path
          ...
          <g className="left-arm">
            <path
              d="M190.406 187.459 179.885 166l-25.479 11.9 3.454 26.1z"
              fill="#425059"
            />
            <path
            ...
            <g className="sword">
              <path
                d="m186.012 182-4.606-8.634L214.785 156l4.621 8.627z"
                fill="#9f582c"
              />

              <path
                d="m236.465 156-5.059-9.604L281.354 120l5.052 9.605z"
                fill="#425059"
              />
              <path
                d="m220.406 141.085 9.97 8.915 46.694-24.5 3.558.396 30.778-16.152L285.343 107z"
                fill="#bcc4cd"
              />
              <path
                d="M232.406 153.765 234.172 167l64.819-34.055L311.406 110l-30.719 16.14-1.673 3.143z"
                fill="#8192a4"
              />
              <path
          ...
          <path
            d="M133.406 148.962c22.3-12.575 50.494-4.606 63 17.768L151.596 192z"
            fill="#8192a4"
          />
          <path
          ...
          />
          <path
            d="M136.406 141h26.324c3.6-7.336 5.676-15.55 5.676-24.266 0-19-9.608-35.759-24.237-45.734h-7.763z"
            fill="#ed751b"
          />
          <path
          ...
          />
          <path
            d="M128.29 114c-12.035 0-21.884 9.9-21.884 22s9.85 22 21.885 22h23.23c12.037 0 21.885-9.9 21.885-22z"
            fill="#ff8f33"
          />
          <path
          ...
          <g className="right-arm">
            <path
              d="M41.406 195.537 53.93 175l18.476 11.27L63.457 211z"
              fill="#425059"
            />
            <path
            ...
            />
            <path
              d="M28.406 193.024 45.402 165l13.004 7.976L41.411 201z"
              fill="#8192a4"
            />
          </g>
          <path
            d="M137.65 7c31.495 6.176 41.756 43.578 41.756 43.578L139.362 76c-12.316-36.315-1.712-69-1.712-69"
            fill="#ff8f33"
          />
          <path
          ...
          />
          <path
            d="M37.65 7c31.495 6.214 41.756 53.421 41.756 53.421L39.362 86C27.046 49.46 37.651 7 37.651 7"
            fill="#ff8f33"
          />
          <path
          ...
          />
          <path
            d="M45.971 78c-7.638-20.478-.627-49-.627-49 14.433 5.32 22.062 22.253 22.062 22.253l-5.889 16.585z"
            fill="#c44e12"
          />
          <path
          ...
          />
          <path
            d="M96.406 38c-32.032 0-58 25.967-58 58h116c0-32.033-25.968-58-58-58"
            fill="#425059"
          />
          <g className="helmet">
            <path
              d="M216.406 101h-160L168.99 0s45.409 22.221 47.416 101"
              fill="#8192a4"
            />
            <path
          ...
          <path
            d="M88.406 148.044c-21.767-13.556-50.41-6.954-64 14.714L68.15 190z"
            fill="#8192a4"
          />
          <path
          ...
          <path
            ...
            fill="#ff8f33"
            mask="url(#b)"
            transform="translate(68.406 265)"
          />
        </g>
      </svg>
    </VictoryFoxContainer>
