...
export const WizardPig = ({ testID }: WizardPigProps) => {
  return (
    <WizardPigContainer data-testid={testID}>
      <svg
        height="251"
        width="203"
      ...
      >
        ...
        <mask style={{ maskType: 'alpha' }} id="f" fill="#fff">
        ...
        <g fill="none" fill-rule="evenodd" transform="matrix(-1 0 0 1 203 0)">
          ...
          <path
            ...
            fill="url(#e)"
          />
          <path d="M48 217h76v-8H48z" fill="#befffa" />
          <path
          ...
          <path
            ...
            fill="#000"
          />
          <path d="M173 108.78 2 139l49.47-43.358L111.714 85z" fill="url(#g)" />
          <path
