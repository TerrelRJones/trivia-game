...
interface DefeatedFoxProps {
  testID?: string;
}

const DefeatedFoxContainer = styled.div`
  .right-arm {
  ...
  .tail {
    ...
    animation: swing4 0.4s infinite;
...
export const DefeatedFox = ({ testID }: DefeatedFoxProps) => {
  return (
      ...
      <svg height="238" width="478" xmlns="http://www.w3.org/2000/svg">
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <g className="left-arm">
            ...
            />
            <path
              d="M281 163.593 274.048 141 223 155.397 229.946 178z"
              fill="#425059"
            />
            <path
              d="M295 163.504 285.494 132 271 136.5l9.5 31.5z"
              fill="#8192a4"
            />
          </g>
          <path
          ...
          />
          <path
            d="M246 141h26.324c3.6-7.336 5.676-15.55 5.676-24.266 0-19-9.608-35.759-24.238-45.734H246z"
            fill="#ed751b"
          />
          <path
          ...
          />
          <path
            d="M199 153.967c0 9.918 8.063 18.033 17.919 18.033h28.162c9.856 0 17.919-8.115 17.919-18.033L199 135z"
            fill="#ff8f33"
          />
          <path
          ...
          <path
            d="M248.244 8C279.738 14.176 290 51.578 290 51.578L249.956 77c-12.316-36.315-1.712-69-1.712-69"
            fill="#ff8f33"
          />
          <path
          ...
          />
          <path
            d="M156.565 79c-7.638-20.478-.627-49-.627-49C170.371 35.32 178 52.253 178 52.253l-5.89 16.585z"
            fill="#c44e12"
          />
          <path
          ...
          />
          <path
            d="M207 38c-32.032 0-58 25.967-58 58h116c0-32.033-25.968-58-58-58"
            fill="#425059"
          />
          <path
            d="M326 101H167L278.88 0S324.005 22.221 326 101"
            fill="#8192a4"
          />
          <path
          ...
          <path
            d="M249.166 233 245 224.059 278.818 208l4.182 8.935z"
            fill="#9f582c"
          />
          <path
            d="M299.562 210 295 200.446 345.444 177l4.556 9.555z"
            fill="#425059"
          />
          <path
            d="m286 194.757 9.417 9.243 47.071-22.107 3.485.548L377 167.866 351.461 164z"
            fill="#bcc4cd"
          />
          <path
            d="M297 207.815 298.15 221l65.557-30.832L377 168l-31.068 14.612-1.794 3.038z"
            fill="#8192a4"
          />
          <path
          ...
          />
          <path
            d="M167.224 22c23.223 14.136-20.7 52-20.7 52s-24.232-7.825-10.096-40.893z"
            fill="#ea7e2d"
          />
          ...
          <g className="right-arm">
            ...
            />
            <path
              d="M231 189.277 230.183 166l-53.183.714.81 23.286z"
              fill="#425059"
            />
            <path
              d="M244 193.482 242.903 161l-14.903.523L229.093 194zM184.924 143C159.544 143 139 163.601 139 189h51z"
              fill="#8192a4"
            />
            <path
          ...
          />
          <path
            d="m102 126-36.178 1.702s-8.479-2.269 3.957 31.198c13.001 37.439 31.656 26.661 31.656 26.661z"
            fill="#8192a4"
          />
          ...
          <g>
            ...
            />
            <path
              d="M77.776 3.354C71.137 1.304 63.11 0 53.398 0 43.681 0 35.694 1.303 29.13 3.354z"
              fill="#425059"
              mask="url(#b)"
              transform="translate(370 199)"
            />
